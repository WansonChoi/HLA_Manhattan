...
pdf(paste0(out_, ".pdf"), width=16, height=9, pointsize=10) # implementation test (2018.4.25)
...
for (i in 1:NumberofLogistic) {
  ...
  # manhattan plot
  make.fancy.locus.plot.bare("6", (if(i == 1) plot_label_ else ""), locus, min.pos_, max.pos_, max.yaxis_[i], topsignal_[i], NULL, seq(0,max.yaxis_[i],by=10), topcolor=topcol_)
